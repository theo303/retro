...
var file_retro_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_retro_proto_goTypes = []any{
	...
	nil,                  // 8: retro.State.UsersEntry
}
var file_retro_proto_depIdxs = []int32{
	0, // 0: retro.State.stickies:type_name -> retro.Sticky
	8, // 1: retro.State.users:type_name -> retro.State.UsersEntry
	...
	1, // 6: retro.State.UsersEntry.value:type_name -> retro.User
